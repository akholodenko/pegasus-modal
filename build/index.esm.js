...
var Footer = function (_a) {
    ...
    var footerContent = function () {
        return (React.createElement("div", null,
            !isFirstScreen && React.createElement("button", { onClick: function () { return onPrev(); } }, "prev"),
            !isLastScreen && React.createElement("button", { onClick: function () { return onNext(); } }, "next")));
    };
...
var ModalContainer = function (_a) {
    ...
    return (React.createElement("div", { style: containerStyle },
        ...
        React.createElement(Footer, { type: footer || 'inline', isFirstScreen: isFirstScreen(currentScreenIndex), isLastScreen: isLastScreen(currentScreenIndex), onNext: onNext, onPrev: onPrev })));
};
...
var PegasusModal = function (_a) {
    ...
    return (React.createElement(ModalContainer, { data: configWithDefaults.data, screens: configWithDefaults.screens, onClose: onClose, isOpen: !!configWithDefaults.isOpen, footer: configWithDefaults.footer, startScreenIndex: configWithDefaults.startScreenIndex }));
};
